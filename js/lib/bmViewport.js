...
Crafty.c("ViewportFollow", {
    ...
    init: function() { },
    setViewportPadding: function(obj){
       if(obj && typeof obj === "object"){
          this.viewportPadding = obj;
       }
    },
        ...
        this.bind('Moved', function(from) {
            ...
            if(this.mapBoundary.containsPoint(vpx_min, this._y) && this.mapBoundary.containsPoint(vpx_max + Crafty.viewport.width, this._y)) {
                ...
                if(this._x + Crafty.viewport.x <= this.viewportPadding.left){
                    xpos = -(this._x - this.viewportPadding.left);
                    ...
                    xpos = -(this._x + this._w - (Crafty.viewport.width - this.viewportPadding.right));
            ...
            if(this.mapBoundary.containsPoint(this._x, vpy_min) && this.mapBoundary.containsPoint(this._x, vpy_max + Crafty.viewport.height)) {
                ...
                if(this._y + Crafty.viewport.y <= this.viewportPadding.top){
                    ypos = -(this._y - this.viewportPadding.top);
                    ...
                    ypos = -(this._y + this._h - (Crafty.viewport.height - this.viewportPadding.bottom));
            ...
            if(xpos || ypos){
               Crafty.trigger("ViewportMoved", {x: xpos - this._lastXPos, y:ypos - this._lastYPos});
               this._lastXPos = xpos;
               this._lastYPos = ypos;
            }
        });
